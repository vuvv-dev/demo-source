...
const navData: NavItem[] = [
  {
    ...
    featured: { name: 'iPhone 16 Pro Max', image: 'https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=400', price: 39990000, slug: 'iphone-16-pro-max' },
    subLinks: [
  ...
  },
  {
    ...
    featured: { name: 'iPad Pro M4', image: 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=400', price: 27990000, slug: 'ipad-pro' },
    subLinks: [
  ...
  },
  {
    ...
    featured: { name: 'MacBook Pro M3', image: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400', price: 36990000, slug: 'macbook-pro' },
    subLinks: [
  ...
  },
  {
    ...
    featured: { name: 'AirPods Pro 2', image: 'https://images.unsplash.com/photo-1606220588913-b3aacb4d5f3d?w=400', price: 6490000, slug: 'airpods-pro-2' },
    subLinks: [
  ...
  },
  {
    ...
    featured: { name: 'Apple Watch Ultra 2', image: 'https://images.unsplash.com/photo-1434493789847-2f02dc6ca35d?w=400', price: 16990000, slug: 'apple-watch-ultra-2' },
    subLinks: [
  ...
  },
  {
    ...
    featured: { name: 'MagSafe Charger', image: 'https://images.unsplash.com/photo-1595407660626-db35dcd0d71f?w=400', price: 1490000, slug: 'magsafe-charger' },
    subLinks: [
  ...
  return (
    <div className="mega-dropdown absolute top-full left-1/2 -translate-x-1/2 mt-0 w-[700px] bg-white rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.12),0_2px_8px_rgba(0,0,0,0.06)] border border-gray-100/80 overflow-hidden z-50">
      <div className="grid grid-cols-[1fr_220px] divide-x divide-gray-50">
        ...
        {/* Featured product */}
        <Link href={`/products/${item.featured.slug}`} className="group p-5 flex flex-col items-center justify-center bg-[#fafafa] hover:bg-[#f0f0f0] transition-colors">
